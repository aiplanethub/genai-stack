...
* [🛠 Getting set up](fundamentals/getting-set-up/README.md)
  * [📙 Colab/Kaggle/Notebook](fundamentals/getting-set-up/colab-kaggle-notebook.md)
  * [🗒 Without Vector Store](fundamentals/getting-set-up/without-vector-store.md)
  * [📝 With a Vector Store](fundamentals/getting-set-up/with-a-vector-store.md)
  * [📜 LLM Stack UI](fundamentals/getting-set-up/llm-stack-ui.md)
* [🧑 CONTRIBUTING.md](fundamentals/contributing.md.md)
