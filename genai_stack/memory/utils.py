...
def parse_vectordb_chat_conversations(search_results: List[Document], k: int) -> str:
    history = ""
...
def create_kwarg_map(config: dict) -> dict:
    ...
    kwarg_map = {
        "ChromaDB": {"index_name": index_name},
        "Weaviate": {
...
def format_conversation(user_text: str, model_text: str) -> str:
